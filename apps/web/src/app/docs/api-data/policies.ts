...
export const policiesSection: DocSection = {
  ...
  endpoints: [
    ...
    /* ------------------------------------------------------------------ */
    {
      id: 'create-policy',
      method: 'POST',
      path: '/api/v1/organizations/:orgId/policies',
...
echo $response;`,
    ...
    /* ------------------------------------------------------------------ */
    {
      id: 'get-policy',
      method: 'GET',
      path: '/api/v1/organizations/:orgId/policies/:policyId',
      title: 'Get a policy',
...
echo $response;`,
    ...
    /* ------------------------------------------------------------------ */
    {
      ...
      method: 'GET',
      path: '/api/v1/organizations/:orgId/policies/password',
...
echo $response;`,
    ...
    /* ------------------------------------------------------------------ */
    {
      id: 'evaluate-policy',
      method: 'POST',
      path: '/api/v1/organizations/:orgId/policies/evaluate',
