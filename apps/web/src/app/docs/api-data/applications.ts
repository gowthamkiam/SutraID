...
echo $response;`,
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      responseFields: [
        { name: 'issuer', type: 'string', description: 'Token issuer identifier.', example: 'https://api.sutraid.com/org_01hxyz' },
        { name: 'authorization_endpoint', type: 'string', description: 'Authorization endpoint URL.', example: 'https://api.sutraid.com/api/v1/oauth/authorize' },
        { name: 'token_endpoint', type: 'string', description: 'Token endpoint URL.', example: 'https://api.sutraid.com/api/v1/oauth/token' },
        { name: 'userinfo_endpoint', type: 'string', description: 'UserInfo endpoint URL.', example: 'https://api.sutraid.com/api/v1/oauth/userinfo' },
        { name: 'jwks_uri', type: 'string', description: 'JSON Web Key Set endpoint URL.', example: 'https://api.sutraid.com/api/v1/.well-known/jwks.json' },
        { name: 'scopes_supported', type: 'string[]', description: 'List of supported scopes.', example: '["openid", "profile", "email", "phone", "address"]' },
